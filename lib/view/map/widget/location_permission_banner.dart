    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.location_off, color: context.colorScheme.error, size: 24),
              const SizedBox(width: 12),
              Expanded(
                child: Text(
                  LocaleKeys.location_permission_title.tr(),
          ...
          Text(
            LocaleKeys.location_permission_description.tr(),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              icon: Icon(Icons.settings, size: 18, color: context.colorScheme.onPrimary),
              label: Text(
                LocaleKeys.location_permission_go_to_settings.tr(),
